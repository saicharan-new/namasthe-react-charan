        ...
        <div>
            <div className="flex flex-col gap-6">
                {items.map(item => <div className="p-5 flex justify-between border bg-white rounded-lg shadow-xl" key={item.card.info.id}>
                    ...
                    <button className="px-2 py-2 bg-white flex items-center justify-center text-green-400 border border-green-400 rounded-lg max-h-7 absolute bottom-[-12px] left-[52px] shadow-green-200">Add +</button>
                    </div>
